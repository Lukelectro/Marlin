...
#define STRING_CONFIG_H_AUTHOR "(Lucas, LM90_N1)" // Who made the changes.
...
#define MACHINE_UUID "9e2f4e82-9f22-481f-8704-bc88742cb5ef"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  //MM90_N1_JHEADMK5, autotune results
  #define  DEFAULT_Kp 22.69
  #define  DEFAULT_Ki 3.25
  #define  DEFAULT_Kd 39.59
...
#define X_HOME_DIR -1
#define Y_HOME_DIR -1
#define Z_HOME_DIR 1 // Mendel90 top home
